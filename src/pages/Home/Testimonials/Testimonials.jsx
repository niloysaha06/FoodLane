          ...
          <SwiperSlide key={review?._id}>
            <div className="flex flex-col items-center mx-24 my-16">
              <Rating
                ...
                readOnly
              />
              <div className="w-24 h-24 relative flex-col justify-start items-start inline-flex my-5">
              ...
              <p className="w-90 text-neutral-700 text-xl font-normal leading-9 py-4">
                {review?.details}
              </p>
              <p className="text-yellow-600 text-3xl font-medium">
                {review?.name}
              </p>
            </div>
          </SwiperSlide>
